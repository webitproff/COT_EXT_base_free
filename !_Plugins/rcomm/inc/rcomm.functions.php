 ...
 function rcomm_last_date($id)
{	global   $db,$db_com ;
    ...
    $delarrdt = $db->query("SELECT com_reply_date  FROM $db_com WHERE  (com_reply_date > ".$arrcomdate['com_reply_date'].") AND  ( com_level <= ".$arrcomdate['com_level'].") ORDER BY com_reply_date ASC LIMIT 1" )->fetch();
