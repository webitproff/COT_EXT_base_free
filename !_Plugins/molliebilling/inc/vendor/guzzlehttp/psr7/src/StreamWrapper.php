...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5d8cb17438769\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5d8cb17438769\Psr\Http\Message\StreamInterface $stream)
    {
