...
require_once cot_incfile('sendpulse', 'plug', 'interface');

define( 'SENDPULSE_API_USER_ID', $cfg['plugin']['sendpulse']['apiuserid'] );
define( 'SENDPULSE_API_SECRET', $cfg['plugin']['sendpulse']['apisecret'] );
define( 'SENDPULSE_TOKEN_STORAGE', 'file' );
