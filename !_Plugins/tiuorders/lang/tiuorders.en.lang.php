...
$L['tiuorders_paid_mail_toseller_body'] = 'Поздравляем! Пользователь оформил и оплатил заказ № {$order_id} ({$product_title}). Если у покупателя не будет претензий к приобретенному товару/услуге, то по истечению гарантийного срока ({$warranty} дней) на ваш счет поступит оплата в размере {$summ} с учетом комиссии сервиса {$tax}%. Подробности заказа смотрите по ссылке:  {$link}';

$L['tiuorders_paid_mail_tocustomer_header'] = 'Заказ № {$order_id} оплачен';
$L['tiuorders_paid_mail_tocustomer_body'] = 'Поздравляем! Вы оплатили заказ № {$order_id} ({$product_title}) на сумму {$cost}. Подробности заказа смотрите по ссылке:  {$link}';

$L['tiuorders_done_mail_toseller_header'] = 'Выплата по заказу № {$order_id} ({$product_title})';
$L['tiuorders_done_mail_toseller_body'] = 'Поздравляем! На ваш счет поступила оплата по заказу № {$order_id} ({$product_title}) в размере {$summ} с учетом комиссии сервиса {$tax}%. Подробности заказа смотрите по ссылке: {$link}';
...
$L['tiuorders_claim_payments_seller_desc'] = 'Выплата за заказ №{$order_id} ({$product_title}), согласно решению администрации сайта.';
$L['tiuorders_claim_payments_customer_desc'] = 'Возврат за заказ №{$order_id} ({$product_title}), согласно решению администрации сайта.';
...
$L['tiuorders_addclaim_mail_toseller_body'] = 'Покупатель подал жалобу по заказу № {$order_id} ({$product_title}). Подробность смотрите по ссылке: {$link}';

$L['tiuorders_addclaim_mail_toadmin_header'] = 'Жалоба по заказу № {$order_id}';
$L['tiuorders_addclaim_mail_toadmin_body'] = 'Покупатель подал жалобу по заказу № {$order_id} ({$product_title}). Подробность смотрите по ссылке: {$link}';

$L['tiuorders_acceptclaim_mail_toseller_header'] = 'Отмена заказа № {$order_id}';
$L['tiuorders_acceptclaim_mail_toseller_body'] = 'Заказ № {$order_id} ({$product_title}) отменен в связи с тем, что покупатель подал жалобу. Подробности смотрите по ссылке: {$link}';

$L['tiuorders_acceptclaim_mail_tocustomer_header'] = 'Отмена заказа № {$order_id}';
$L['tiuorders_acceptclaim_mail_tocustomer_body'] = 'Заказ № {$order_id} ({$product_title}) отменен в связи с вашей жалобой. Подробности смотрите по ссылке: {$link}';

$L['tiuorders_cancelclaim_mail_tocustomer_header'] = 'Жалобы по заказу № {$order_id} отклонена';
$L['tiuorders_cancelclaim_mail_tocustomer_body'] = 'Ваша жалоба по заказу № {$order_id} ({$product_title}) отклонена администрацией сайта. Подробности смотрите по ссылке: {$link}';

$L['tiuorders_file'] = 'Files for sale';
$L['tiuorders_file_for_download'] = 'Files for download';
$L['tiuorders_file_download'] = 'Download files';