...
(!empty($usr_geoinfo['country'])) && $where['item_country'] = "item_country='" . $usr_geoinfo['country']."'";
...
{
  ((int) $usr_geoinfo['region'] > 0) && $where['item_region'] = "item_region=" . $usr_geoinfo['region'];
  ((int) $usr_geoinfo['city'] > 0) && $where['item_city'] = "item_city=" . $usr_geoinfo['city'];
}