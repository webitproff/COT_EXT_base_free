$('[id="locselectcountry"]').live("change", function(){
	...
	if(val != '0')
	{
		$.get('index.php?r=geotargeting', {country: val},
		function(data){
...
$('[id="locselectregion"]').live("change", function(){
	var parent = $(this).closest('.locselect');
	var city = $(parent).find('#locselectcity');
	...
	if(val != '0')
	{	
		$.get('index.php?r=geotargeting', {region: val},
		function(data){
