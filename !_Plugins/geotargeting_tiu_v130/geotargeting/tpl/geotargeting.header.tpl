...
<li class="dropdown {GEOTARGETING_DROP_OPEN}">            
	<a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-map-marker"></i> {GEOTARGETING_NAME_SELECT}<b class="caret"></b></a>
...
<!-- ELSE -->                
<li>
  <a href="#" data-toggle="modal" onClick="$('#GeoModal').modal(); return false;"><i class="icon-map-marker"></i> {GEOTARGETING_NAME_SELECT}</a> 
</li>
<!-- ENDIF -->
