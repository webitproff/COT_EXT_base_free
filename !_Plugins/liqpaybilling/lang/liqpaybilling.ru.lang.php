...
$L['liqpaybilling_formtext'] = 'Сейчас вы будете перенаправлены на сайт платежной системы LiqPay для проведения оплаты. Если этого не произошло, нажмите кнопку "Перейти к оплате".';
$L['liqpaybilling_formbuy'] = 'Перейти к оплате';
$L['liqpaybilling_error_wait'] = 'Платеж находится на проверке. Пожалуйста, подождите.';
