...
<!-- BEGIN: COMMENTS_FORM_EDIT -->
			<form id="answers" name="answers" action="{COMMENTS_FORM_POST}" method="post">
				<table class="cells">
					<tr>
...
<!-- BEGIN: COMMENTS -->
		...
		<br/>
		<br/>
		<div class="mboxHD answers">{PHP.L.answers_answers}</div>
<!-- BEGIN: COMMENTS_ROW -->
		<div class="row answer">
			...
			<div class="span8">
				<div class="pull-right">{COMMENTS_ROW_LIKERATINGS_DISPLAY}</div>
			...
			<div class="span8"><hr class="clear divider" /></div>
		</div>
<!-- END: COMMENTS_ROW -->
...
<!-- BEGIN: COMMENTS_NEWCOMMENT -->
		<div class="mboxHD answers">{PHP.L.Newanswer}</div>
		{FILE "{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/warnings.tpl"}
		<form action="{COMMENTS_FORM_SEND}" method="post" name="newanswer">
			<!-- BEGIN: GUEST -->
